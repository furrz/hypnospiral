...
export const useWpm = createHashState('wpm', 200)
...
export const useRsvp = createHashState('Rsvp', false)
...
export const useHighlightColour = createHashState('highlightColour', { r: 255, g: 0, b: 0 })
export const useHighlightPos = createHashState('highlightPos', 0.4)
export const useForcePerfectCenterText = createHashState('forcePerfectCenterText', false)
export const useTextVrSplit = createHashState('textVrSplit', false)
export const useTextVrOffset = createHashState('textVrOffset', 0)
